...
Background <- readBed(file = "/Users/annieciernia/Box\ Sync/Ashwood_labcollaboration/Experiments/atac_2019/DiffBind/Allconsensuspeaks.bed")
...
setwd("/Users/annieciernia/Box\ Sync/Ashwood_labcollaboration/Experiments/atac_2019/peak_overlaps")
...
write.csv(merge2,file="FisherExact_TF_Enrichements_5_1_19.csv")
...
neworder <- c("BTBRmedia<C57media" ,"BTBRmedia>C57media",
              "C57media<LPS1only","BTBRmedia<LPS1only",
              "C57media<LPS2only", "BTBRmedia<LPS2only",
              "C57media<LPS1&2", "BTBRmedia<LPS1&2",
              "C57media>LPS1only","BTBRmedia>LPS1only",
              "C57media>LPS2only", "BTBRmedia>LPS2only",
              "C57media>LPS1&2", "BTBRmedia>LPS1&2",
...
ggsave(filename="Collection5678_BMDMmarks_5_2_19.pdf",width = 16, height = 6, dpi = 300,  useDingbats = FALSE)
